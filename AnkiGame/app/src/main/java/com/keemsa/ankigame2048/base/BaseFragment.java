...
import com.keemsa.ankigame2048.injection.component.ActivityComponent;
import com.keemsa.ankigame2048.injection.component.ConfigPersistentComponent;
import com.keemsa.ankigame2048.injection.component.DaggerConfigPersistentComponent;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!sComponentsMap.containsKey(mFragmentId)) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent
                    .builder()
                    .applicationComponent(Ankigame2048Application.get(getContext()).getComponent())
                    .build();
